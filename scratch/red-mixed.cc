...
NS_LOG_COMPONENT_DEFINE("RedMixedTraffic");
...
int main(int argc, char *argv[])
{
  ...
  LogComponentEnable("RedMixedTraffic", LOG_LEVEL_INFO);
  ...
  NS_LOG_INFO("Running RED with Mixed Traffic for " << simTime << " seconds");
  ...
  std::cout << "RED Mixed Traffic Statistics:" << std::endl;
